...
const todoEs = {
  "all": {
    "audio": "/audiobook/audio/es/LA-LEY-DEL-UNO-AUDIOLIBRO-COMPLETO-TTS.mp3",
    "pdf": "/pdf/es/el-uno-libro-completo.pdf",
    "youtube": ""
  }
};
...
for (let i = 1; i <= 11; i++) {
  ...
  todoEs[i.toString()] = {
    "pdf": `/pdf/es/el-uno-cap-${num}-${todoChapters[i - 1]}.pdf`,
    "audio": `/audiobook/audio/es-tts/${todoAudioFiles[i - 1]}.mp3`,
    "youtube": ""
  };
}
...
const sanacionEn = {
  ...
  "1": {
    "audio": "/audiobook/audio/en/ch1/ch1-en.mp3",
    "pdf": "",
    "youtube": ""
  }
};
...
const jesusEs = {
  "all": {
    "audio": "/audiobook/audio/es/EL-CAMINO-DEL-AMOR-AUDIOLIBRO-COMPLETO.mp3",
    "pdf": "",
    "youtube": ""
  }
};
...
for (let i = 1; i <= 11; i++) {
  jesusEs[i.toString()] = {
    "audio": `/audiobook/audio/es/${jesusFiles[i - 1]}.mp3`,
    "pdf": "",
    "youtube": ""
  };
}
...
console.log("Archivos media.json actualizados correctamente (SIN prefijos).");
